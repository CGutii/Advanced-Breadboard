...
class TranslateScreen:
    def __init__(self, master, circuit_simulator_instance, num_nodes=0, connections=[]):
        ...
        #self.reset_LEDs_btn = tk.Button(master, text="Reset Circuit", command=self.reset_pins) # added
        #self.reset_LEDs_btn.pack()
        ...
        self.master.protocol("WM_DELTE_WINDOW", self.reset_pins)
    ...
    def reset_pins(self):
        self.circuit_simulator.reset_pins();
